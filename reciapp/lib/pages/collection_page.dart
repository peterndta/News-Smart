...
class _CollectionPageState extends State<CollectionPage> {
  ...
  void initState() {
    super.initState();
    getAllData();
    fetchInfinitePosts(collectionName, keywords, 0);
  ...
  bool hasMore = true;
  String collectionName = "Breakfast";
  String keywords = "";
  List<String> listCollections = [];

  Future fetchInfinitePosts(
      String collection, String keyword, int pages) async {
    if (isLoading) return;
    UserData userData =
        UserData.fromJson(jsonDecode(UserPreferences.getUserInfo()));
    isLoading = true;
    const limit = 6;
    var collectionNameString = "";
    if (collection.isNotEmpty) {
      collectionNameString = "&Collection=" + collection;
    }
    var search = "";
    ...
    print('Call: ' +
        'https://reciapp.azurewebsites.net/api/collections/post/page/$page?PageSize=$limit$collectionNameString$search&Sort=$sortKey');
                ...
                children: [
                  Positioned(
                    child: Container(
                      ...
                      color: const Color.fromARGB(255, 255, 231, 185),
                    ),
                  ),
                  Positioned(
                    top: 20,
