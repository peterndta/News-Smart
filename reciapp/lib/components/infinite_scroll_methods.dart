...
class InfiniteScrollMethods extends StatefulWidget {
  const InfiniteScrollMethods({Key? key}) : super(key: key);

  @override
  _InfiniteScrollMethodsState createState() => _InfiniteScrollMethodsState();
}

class _InfiniteScrollMethodsState extends State<InfiniteScrollMethods> {
  ...
  Future fetchInfinitePosts() async {
    ...
    http.Response response = await http.get(
      Uri.parse(
          'https://reciapp.azurewebsites.net/api/method/post/page/$page?${urlFilter}PageSize=$limit'),
      headers: {
